...
```bash
   git clone https://github.com/MinorRojas/sistema_gestion_biblioteca-progracion_IV.git
```
...
4. Configurar la cadena de conexión a SQL Server en `appsettings.json`.
5. Aplicar las migraciones de Entity Framework para crear la base de datos:
```bash
...
Pendiente de agregar el link una vez desplegado en el hosting.
